...
const Icon = ({ name }: { name: 'home' | 'leads' | 'projects' | 'media' | 'sites' | 'design' | 'team' | 'more' | 'search' | 'bell' | 'sparkles' }) => {
  ...
  if (name === 'design') return <svg {...common}><path d="M4 20h16"/><path d="M6 16V5h12v11"/><path d="M6 11h12"/><path d="M12 5v11"/><path d="M8.5 8h1M14.5 13h1"/></svg>;
