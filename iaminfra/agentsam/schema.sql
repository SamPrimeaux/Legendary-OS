-- Legendary OS reusable Agent Sam operational schema.
-- Project context is intentionally ticket-linked; tickets are the planning/work anchor.
...
CREATE TABLE IF NOT EXISTS agentsam_project_context (
  ...
  linked_ticket_id TEXT REFERENCES agentsam_tickets(id) ON DELETE SET NULL,
  client_id TEXT,
  created_by TEXT,
  started_at INTEGER,
