...
const mapSection = (r:Row):CmsSection => ({id:r.id,pageId:r.page_id,type:r.type,name:r.name,zone:r.zone,visible:Boolean(r.visible),sortOrder:Number(r.sort_order),data:parse<Record<string,unknown>>(r.data_json,{})});
