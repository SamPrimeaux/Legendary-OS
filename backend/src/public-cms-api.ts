...
export async function handlePublicCmsApi(request: Request, db: CmsD1Database): Promise<Response | null> {
  ...
  return Response.json(page, { headers: { 'cache-control': 'public, max-age=30, stale-while-revalidate=300' } });
}
